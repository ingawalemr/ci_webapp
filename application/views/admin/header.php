            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url().'admin/Category/create' ?>" class="nav-link 
                  <?php echo(!empty($mainModule) && $mainModule=='category' && !empty($subModule) && $subModule=='createcategory') ? 'active' : '' ?> ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Categories</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'admin/Category/index' ?>" class="nav-link 
                  <?php echo(!empty($mainModule) && $mainModule=='category' && !empty($subModule) && $subModule=='viewcategory') ? 'active' : '' ?> ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Categories</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/Article/index" class="nav-link  
                  <?php echo(!empty($mainModule) && $mainModule=='article' && !empty($subModule) && $subModule == 'viewarticle') ? 'active' : '' ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Articles</p>
                </a>
              </li>
